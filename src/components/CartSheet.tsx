    ...
    <div className="fixed inset-0 z-[100] flex items-end bg-black/75 backdrop-blur-sm" onClick={onClose}>
      ...
      >
        ...
        <button
          ...
          className="w-full rounded-2xl bg-primary text-primary-foreground font-display text-2xl tracking-wider py-4 active:scale-[.98] transition disabled:opacity-40"
        >
          Encaisser
        </button>
      </div>
