...
export type Concert = {
  ...
  /**
   * Quand le montant a été saisi. Sert à dater la ligne « Cachet » de l'export,
   * pour qu'elle se range à sa place parmi les ventes. Absent sur les cachets
   * d'avant ce suivi : on retombe alors sur la date du concert.
   */
  fee_at?: number;
};
